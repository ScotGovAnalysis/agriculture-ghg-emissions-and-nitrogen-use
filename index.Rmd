...
Proportions are based on a [methodology developed by SRUC](https://www.gov.scot/publications/disaggregating-headline-smart-inventory-figures/). The sectoral split of emissions are based on proportions from 2018 and are applied to the entire timeseries. Rows may not sum to 100% due to rounding.

```{r table_1_pct, echo = FALSE, results = 'markup'}
knitr::kable(table_1_pct) %>% kable_styling()
...
>>>>>>> a705197e688e9f8aa5996f7576d64a7868ec2652
<br></br>
