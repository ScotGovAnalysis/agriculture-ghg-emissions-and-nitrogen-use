...
Estimates of GHG emissions for the Scottish agriculture sector are as reported in the Scottish Greenhouse Gas Statistics 2022. Methodology for these results [is available alongside the publication](https://www.gov.scot/publications/scottish-greenhouse-gas-statistics-2022/pages/section-d--revisions-to-the-inventory-and-methodology/).
...
Average farm greenhouse gas and nitrogen use estimates are produced using data collected in the Farm Business Survey. Methodology and quality information about data collected in the FBS and its headline measure of income, Farm Business Income (FBI), is available in the [Scottish farm business income: annual estimates: Methodology - gov.scot (www.gov.scot)](Scottish%20farm%20business%20income:%20annual%20estimates:%20Methodology%20-%20gov.scot%20(www.gov.scot)).

Methodology improvements have been made for 2022-23 emission estimates for the average farm in the 'Scottish Agriculture Greenhouse Gas Emissions and Nitrogen Use: 2022-2023' publication. Results for 2022-23 are not directly comparable to previous years. Previous years have not yet been revised. More information available under Changes to Methodology.

Details about greenhouse gas (GHG) emissions and nitrogen use estimates are included here in line with the [European Statistical System (ESS) quality framework](https://ec.europa.eu/eurostat/web/quality/european-quality-standards/quality-assurance-framework). This covers areas of statistical:
...
Farm level GHG emissions and nitrogen use estimates were first published in June 2023 as [Farm Business Survey 2021-22: Farm level emissions and nitrogen usage.](https://www.gov.scot/publications/farm-business-survey-2021-22-farm-level-emissions-and-nitrogen-usage/)
...
Scottish Government statistics are regulated by the Office for Statistics Regulation (OSR). OSR sets the standards of trustworthiness, quality and value in the [Code of Practice for Statistics](Code%20of%20Practice%20for%20Statistics "https://code.statisticsauthority.gov.uk/the-code/") that all producers of official statistics should adhere to.
...
Farm GHG emissions are produced using the Agricultural Resource Efficiency Calculator ([Agrecalc](https://www.agrecalc.com/)). For 2022-23, the following changes were made:
...
Agrecalc have published more information about [changes to the platform](https://www.agrecalc.com/home/insights/how-will-my-carbon-footprint-change-in-agrecalc-cloud/).

<br></br>

# Agricultural subsector estimates methodology

Estimates of GHG emissions by agricultural subsector are created by allocating total GHG emissions, as reported in the [Scottish Greenhouse Gas Statistics 2022](https://www.gov.scot/publications/scottish-greenhouse-gas-statistics-2022/) to agricultural subsectors.
...
The classification is based on detailed sub-types as defined in the [European Commission (EC) farm typology](https://eur-lex.europa.eu/legal-content/EN/TXT/PDF/?uri=CELEX:32014R1198&from=en), which have been grouped together where required to give the types shown below.
...
The 'Farm Business Survey: Farm level emissions and nitrogen usage' publication reports on the following headline metrics of nitrogen use:
...
Detail about revisions to the GHG Inventory and methodology are available at <a href = "https://www.gov.scot/publications/scottish-greenhouse-gas-statistics-2022/pages/section-d–revisions-to-the-inventory-and-methodology/" target = "_blank">Scottish Greenhouse Gas Statistics 2022 - gov.scot (www.gov.scot)</a>.
...
Data quality and assurance measures for the June Agricultural Census are available at <a href = "https://www.gov.scot/collections/june-scottish-agricultural-census/" target = "_blank">Scottish Agricultural Census: results - gov.scot (www.gov.scot)</a>.

## The Farm Business Survey

Data quality and assurance measures for the Farm Business Survey and its official statistical outputs are available at <a href = "https://www.gov.scot/collections/scottish-farm-business-income-fbi-annual-estimates/" target = "_blank">Scottish farm business income (FBI) - gov.scot (www.gov.scot)</a>.
...
The 'Scottish Agriculture Greenhouse Gas Emissions and Nitrogen Use: 2022-2023' publication was first released on 27 June 2024 at [Scottish agriculture greenhouse gas emissions and nitrogen use: 2022 -23 - (data.gov.scot).](https://data.gov.scot/scottish-agriculture-greenhouse-gas-emissions-nitrogen-use-2022-23/)
